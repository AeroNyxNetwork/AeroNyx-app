/*
 * @Description:
 * @Date: 2025-03-24 16:22:50
 * @LastEditTime: 2025-03-24 17:57:17
 */
...
export async function MyNode_Withdraw(
  wallet: any,
  publicKey: PublicKey,
  amount: number,
  ...
  try {
    const txSignature = await program.methods
      .withdraw(new anchor.BN(BnNumber))
      .accounts({
        mainAccount,
        infoAccount,
        vault,
      ...
      .signers([])
      .rpc();
    return { code: "success", msg: txSignature };
  } catch (err) {
